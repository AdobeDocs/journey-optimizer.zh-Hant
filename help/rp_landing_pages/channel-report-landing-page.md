...
了解如何存取及運用 Adobe Journey Optimizer 中的「所有期間報告」功能，該功能已與 Customer Journey Analytics 整合，以提供更優異的洞察。
...
- **[行銷活動報告](campaign-reporting-landing-page.md)** — 存取多個管道的詳細行銷活動績效洞察、參與追蹤和最佳化指引。
