...
description: 瞭解如何使用自訂動作，透過 Adobe Campaign Standard、Campaign v7/v8 和 Marketo Engage，從 Journey Optimizer 歷程傳送訊息。
...
[與 Campaign Standard 整合](../using/action/acs-action.md)
:::
...
[與 Campaign v7/v8 整合](../using/action/acc-action.md)
:::
