...
[最佳化行銷活動](../using/content-management/gs-message-optimization.md)
:::
...
- **[排程動作行銷活動](../using/campaigns/campaign-schedule.md)** — 設定行銷活動的開始和結束日期、頻率及通道特定排程。
- **[檢閱及啟動動作行銷活動](../using/campaigns/review-activate-campaign.md)** — 使用逐步指示驗證、檢閱及啟動您的動作行銷活動。
