...
**[衝突偵測](../using/conflict-prioritization/conflicts.md)** — 可識別針對相同對象之重疊行銷活動和歷程的工具。 有限歷程支援：單一、對象資格和讀取對象型別。 [了解衝突管理](../using/conflict-prioritization/gs-conflict-prioritization.md)
