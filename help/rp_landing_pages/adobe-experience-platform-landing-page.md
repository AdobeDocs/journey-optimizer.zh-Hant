...
瞭解如何存取和使用 Adobe Experience Platform 輪廓屬性和資料集來個人化訊息和歷程條件。
...
瞭解如何直接在歷程條件、動作和運算式中查詢和搜尋 Adobe Experience Platform 資料。

[在歷程中使用 AEP 資料](../using/data/lookup-aep-data.md)
:::
