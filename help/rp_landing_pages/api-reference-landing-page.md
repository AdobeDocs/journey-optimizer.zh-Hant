...
title: API 參考
description: 瞭解如何使用優惠資料庫API和傳送API，將決定管理整合至您的工作流程中，並大規模提供個人化優惠。
...
[探索傳送API](offer-delivery-api-landing-page.md)
:::
...
存取用於管理位置、決定規則、集合限定詞、個人化優惠、集合、遞補優惠和決定的API參考。

[瀏覽優惠資料庫API](../using/offers/api-reference/getting-started.md)
:::
