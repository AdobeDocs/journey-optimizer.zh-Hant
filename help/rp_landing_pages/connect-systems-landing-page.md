...
Adobe Journey Optimizer 可讓您順暢地連線系統和環境，確保您的客戶歷程在每一個步驟都包含正確的資料和工具。無論您是要與其他 Adobe 解決方案、第三方平台整合，還是要運用 API，您都能了解如何統一工作流程、個人化體驗及簡化程序。深入了解使用沙箱管理環境、連結外部系統以擴充資料，或啟用 AI 驅動型洞察以更聰明地行銷等主題。每個區段的設計都可協助您解鎖新的可能性，讓您更輕鬆地在連線的生態系統中建立有凝聚力、具影響力的客戶體驗。
...
[管理沙箱](../using/administration/sandboxes.md)
:::
