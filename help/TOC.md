...
+ 內容管理 {#content-management}
   ...
   + 管理可重複使用的內容 {#reusable-content}
      + [使用內容範本](using/content-management/content-templates.md)
...
+ 追蹤和監視 {#reporting}
   ...
   + 傳遞能力 {#deliverability}
      ...
      + [強制性DMARC更新](using/configuration/dmarc-record-update.md)
   + [錯誤原因](using/reports/error-list.md)
...
+ 設定 {#configuration}
   ...
   + [設定管道表面](using/configuration/channel-surfaces.md)
