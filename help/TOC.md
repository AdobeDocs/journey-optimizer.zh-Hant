...
+ 開始使用 {#get-started}
   ...
   + 高效工作 {#work-efficiently}
      ...
      + [疑難排解常見問題](https://experienceleague.adobe.com/en/docs/journey-optimizer/using/monitor/troubleshooting/troubleshooting)
...
+ 通訊管道 {#channels}
   ...
   + 電子郵件管道 {#email}
      ...
      + 設計您的電子郵件內容 {#design-email}
         ...
         + 設計內容 {#add-content}
            ...
            + [針對AI收件匣最佳化電子郵件](using/email/llm-email-optimizer.md)
   ...
   + 收件匣 {#inbox}
      ...
      + [在Journey Optimizer中設定收件匣頻道](using/inbox/inbox-configuration.md)
...
+ 內容管理 {#content-management}
   ...
   + 個人化 {#personalization}
      ...
      + [加密追蹤連結中的URL引數](using/personalization/url-parameter-encryption.md)
      + 協助程式函式清單 {#functions}
