...
+ 內容管理 {#content-management}
   + 用於產生內容的AI小幫手{#ai-assistant}
      ...
      + [具有AI的登陸頁面](using/content-management/generative-lp.md)
   ...
   + 個人化 {#personalization}
      ...
      + 使用個人化編輯器 {#expression-editor}
         + [開始使用個人化編輯器](using/personalization/personalization-build-expressions.md)
...
+ 決定功能{#decisioning}
   ...
   + 決定管理 {#offer-decisioning}
      ...
      + 善用內容資料{#context-data}
         ...
         + [內容資料與Edge Decisioning請求](using/offers/context-data-edge.md)
