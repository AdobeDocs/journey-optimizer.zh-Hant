  ...
  + 電子郵件管道 {#email}
    ...
    + 設計您的電子郵件內容 {#design-email}
      ...
      + 撰寫您的內容 {#add-content}
        ...
        + [使用模組](using/email/email-modules.md)
...
+ 內容管理 {#content-management}
  ...
  + 產生內容 {#generate-content}
    ...
    + [產生內容中的Content Credentials](using/content-management/generative-c2pa-metadata.md)
...
+ 管道設定 {#configuration}
  ...
  + [管理允許的 IP](using/configuration/waf-ip-allowlist.md)
