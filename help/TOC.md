...
+ 消息{#create-messages}
   ...
   + 電子郵件設計工具{#email-designer}
      ...
      + [使用電子郵件設計工具內容元件](using/content-components.md)
   + 個性化{#personalization}
      + [開始使用](using/personalization/personalize.md)
      + [個人化區域](using/personalization/personalization-aeras.md)
      ...
      + 輔助函式{#functions}
         + [幫助函式清單](using/personalization/functions/functions.md)
   ...
   + [新增個人化優惠方案](using/deliver-personalized-offers.md)
...
+ 設定{#get-started}
   ...
   + 配置消息{#configuration}
      ...
      + 推播通知設定{#push-config}
         + [推播通知快速入門](using/push-gs.md)
         + [設定推播通道](using/push-configuration.md)
      + 電子郵件配置{#email-config}
         + 委派子網域{#delegate-subdomains}
            ...
            + [訪問PTR記錄](using/configuration/ptr-records.md)
         ...
         + [更改電子郵件主地址](using/configuration/primary-email-addresses.md)
