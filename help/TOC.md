...
+ 開始使用{#get-started}{#get-started}
   + [什麼是 Journey Optimizer](using/start/get-started.md)
   + 快速入門手冊{#quick-start}{#quick-start}
...
+ 歷程{#orchestrate-journeys} {#orchestrate-journeys}
   + [開始使用歷程](using/building-journeys/journey.md)
   + 建立歷程{#create-journey}{#create-journey}
   ...
   + 管理您的歷程{#manage-journey}{#manage-journey}
   ...
   + 活動{#about-journey-building} {#about-journey-building}
   ...
   + 建置運算式{#building-advanced-conditions-journeys} {#building-advanced-conditions-journeys}
      ...
      + 函式{#main-functions-journey} {#main-functions-journey}
         + [主要功能](using/building-journeys/expression/functions.md)
         + Adobe Experience Platform {#adobe-experience-platform} {#adobe-experience-platform}
            + [inAudience](using/building-journeys/functions/functioninaudience.md)
         + 彙總{#aggregation} {#aggregation}
   ...
   + 使用案例{#journey-use-cases} {#journey-use-cases}
      + 業務使用案例{#business-use-cases} {#business-use-cases}
      ...
      + 技術使用案例{#technical-use-cases} {#technical-use-cases}
...
+ 多步驟行銷活動{#ms-campaigns} {#ms-campaigns}
   ...
   + 多步驟行銷活動{#design-campaigns} {#design-campaigns}
...
+ 衝突管理與優先順序{#conflict-prioritization} {#conflict-prioritization}
...
+ 測試並核准{#test} {#test}
   + 預覽和測試內容{#preview-test} {#preview-test}
...
+ 通訊管道{#channels} {#channels}
   ...
   + 電子郵件頻道{#email} {#email}
      ...
      + 設計您的電子郵件內容{#design-email} {#design-email}
         ...
         + 設計您的內容{#add-content} {#add-content}
      ...
      + 設定電子郵件頻道{#configure-email} {#configure-email}
   ...
   + 推播通知頻道{#push}{#push}
      ...
      + 設定推播通知{#push-config}{#push-config}
   ...
   + 簡訊/多媒體簡訊頻道{#sms}{#sms}
      ...
      + 設定簡訊/多媒體簡訊頻道{#configure-sms}{#configure-sms}
   ...
   + 網路頻道{#web} {#web}
      ...
      + 設定Web Channel {#configure-web-channel} {#configure-web-channel}
      ...
      + 製作網頁{#author-web-pages} {#author-web-pages}
   ...
   + 程式碼型體驗{#code-based-experience} {#code-based-experience}
      + [開始使用程式碼型頻道](using/code-based/get-started-code-based.md)
      + 設定程式碼型管道{#configure-code-based-channel} {#configure-code-based-channel}
      ...
      + 建立程式碼型體驗{#create-code-based-experiences} {#create-code-based-experiences}
   ...
   + 內容卡片{#content-card}{#content-card}
      + [開始使用內容卡](using/content-card/get-started-content-card.md)
      + 設定內容卡片頻道{#configure} {#configure}
...
+ 登陸頁面{#landing-pages} {#landing-pages}
   ...
   + 設定登陸頁面{#lp-configuration} {#lp-configuration}
      + [設定登陸頁面子網域](using/landing-pages/lp-subdomains.md)
      + [定義登陸頁面預設集](using/landing-pages/lp-presets.md)
+ 內容管理{#content-management} {#content-management}
   + 用於產生內容的AI助理{#ai-assistant}{#ai-assistant}
   ...
   + 使用多語言內容{#content-multilingual}{#content-multilingual}
   ...
   + Personalization {#personalization} {#personalization}
      ...
      + Personalization使用案例{#personalization-use-cases}{#personalization-use-cases}
   ...
   + 內容範本{#content-templates} {#content-templates}
   ...
   + 可重複使用的內容片段{#fragments} {#fragments}
...
+ 對象、設定檔與身分{#audiences-profiles-identities}{#audiences-profiles-identities}
   + 對象{#audiences} {#audiences}
...
+ 追蹤和監視{#reporting} {#reporting}
   + 即時報告{#live-report} {#live-report}
   ...
   + 所有時間報表{#channel-report}{#channel-report}
   ...
   + 傳遞能力{#deliverability} {#deliverability}
...
+ 決策功能{#decisioning} {#decisioning}
   + [開始使用決定功能](using/experience-decisioning/gs-decision.md)
   + 決策{#experience-decisioning} {#experience-decisioning}
      ...
      + API參考{#api-reference}{#api-reference}
         + 建立和管理優惠方案專案{#create-manage} {#create-manage}
            + 決定專案{#decision-items}{#decision-items}
            ...
            + 專案集合{#items-collections}{#items-collections}
            ...
            + 選擇策略{#selection-strategies}{#selection-strategies}
            ...
            + 排名公式{#ranking-formulas}{#ranking-formulas}
            ...
            + 適用性規則{#eligibility-rules}{#eligibility-rules}
      ...
      + 管理決定專案{#decision-items} {#decision-items}
   ...
   + 決定管理{#offer-decisioning} {#offer-decisioning}
      + 開始使用決定管理{#get-started-decision} {#get-started-decision}
      ...
      + 建立元件{#create-components} {#create-components}
      ...
      + 建立和管理優惠方案{#managing-offers-in-the-offer-library} {#managing-offers-in-the-offer-library}
         + 設定優惠方案{#configure-offers} {#configure-offers}
      ...
      + 建立和管理決定{#create-manage-activities} {#create-manage-activities}
      ...
      + 收集事件資料{#collect-event-data} {#collect-event-data}
      ...
      + 善用內容資料{#context-data} {#context-data}
      ...
      + API參考{#api-reference} {#api-reference}
         ...
         + 使用API建立和管理優惠方案{#offers-api} {#offers-api}
            + 版位{#placements} {#placements}
            ...
            + 決定規則{#decision-rules} {#decision-rules}
            ...
            + 個人化優惠{#personalized-offers} {#personalized-offers}
            ...
            + 遞補優惠{#fallback-offers} {#fallback-offers}
            ...
            + 決定{#decisions-api} {#decisions-api}
         ...
         + 使用API傳遞優惠方案{#offer-delivery-api} {#offer-delivery-api}
...
+ 資料管理{#data-management} {#data-management}
   + [開始使用資料管理](using/data/gs-data.md)
   + [使用結構描述](using/data/get-started-schemas.md)
   + Journey Optimizer資料集{#datasets} {#datasets}
...
+ 設定{#configuration} {#configuration}
   ...
   + 實作IP熱身計畫{#implement-ip-warmup-plan} {#implement-ip-warmup-plan}
   ...
   + 監視電子郵件地址{#monitor-reputation} {#monitor-reputation}
   ...
   + 設定歷程{#configure-journeys} {#configure-journeys}
      + [設定資料來源、事件和動作](using/configuration/about-data-sources-events-actions.md)
      + 與外部系統{#external-systems}整合 {#external-systems}
      ...
      + 事件設定{#events-journeys} {#events-journeys}
         + [使用歷程事件](using/event/about-events.md)
         + 設定單一事件{#unitary-events} {#unitary-events}
      ...
      + 資料來源組態{#data-source-journeys}{#data-source-journeys}
      ...
      + 動作設定{#action-journeys} {#action-journeys}
