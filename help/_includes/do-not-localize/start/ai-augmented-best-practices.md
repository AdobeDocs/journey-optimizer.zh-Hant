...
* As you near 100 live journeys at one time in a sandbox, an orange overlay and warning sign appear in the interface; to extend beyond 100 live journeys at a time, create a ticket for customer care.
...
* **Q: What happens as I approach 100 live journeys in a sandbox, and how do I go beyond it?** — An orange overlay and warning sign appear in the interface; if you need more, create a ticket for customer care.
