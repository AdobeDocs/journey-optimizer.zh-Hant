...
在Personalization編輯器或電子郵件Designer工具列（**新增運算式**）中使用&#x200B;**AI小幫手**，以純文字描述您想要的內容，並取得個人化運算式，或選取現有程式碼來加以說明、修正問題或建議改進。
