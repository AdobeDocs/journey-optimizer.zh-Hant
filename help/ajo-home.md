...
10月版本現已上線，包括電子郵件內容鎖定、與行動油墨整合、程式碼型與歷程中的Web體驗。 先前在有限可用性(LA)中，現在所有使用者都可以使用以下功能：電子郵件設定個人化、核准政策、歷程中的內容實驗、改善的報告體驗。

[![了解更多](using/assets/do-not-localize/learn-more-button.svg)](using/rn/release-notes.md)

>[!TAB AI 助理]

✨ 使用 [AI 助理內容加速器](../help/using/content-management/gs-generative.md)的即時功能預覽，親身體驗各種實作功能，旨在讓您直接探索各項功能，全面了解所有功能。
...
[![了解更多](using/assets/do-not-localize/learn-more-button.svg)](using/web/create-web.md)
