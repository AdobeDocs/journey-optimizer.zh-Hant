...
動態內容可讓您根據&#x200B;**條件式規則**&#x200B;調整訊息內容，這些規則可由設定檔屬性、內容事件或對象組成。條件式規則是使用個人化編輯器中的視覺化規則產生器來建立，您可以在其中儲存這些規則，以便在歷程及行銷活動中重複使用。

電子郵件設計人員和個人化編輯器中可運用條件式規則，以 **建立動態內容** 它會根據訊息中的目標設定檔進行調整。
