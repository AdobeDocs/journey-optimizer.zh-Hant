...
title: 使用 Adobe Journey Optimizer，報告協調行銷活動
description: 瞭解如何使用 Adobe Journey Optimizer，存取有關協調行銷活動的報告
badge: label="Alpha"
hide: true
hidefromtoc: true
...
<table style="table-layout:auto; width: 100%; border-collapse: collapse;">
  <tbody>
    <tr>
      ...
      <td>
        使用<b>即時報告</b>，就能在內建儀表板中，即時測量，並將協調行銷活動的影響力和效能視覺化。 可從<b>檢視過去 24 小時的報告</b>選單那邊，執行精心安排的行銷活動，之後<b>即時報告</b>那邊，便會提供資料。 若想了解即時報告的詳細資訊，請參閱<a href="../reports/live-report.md">本區段</a>。
      </td>
        </br>
    </tr>
