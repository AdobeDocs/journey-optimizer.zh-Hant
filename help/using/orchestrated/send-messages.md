...
title: 使用協調的行銷活動，傳送訊息
description: 瞭解如何透過Adobe Journey Optimizer使用協調的行銷活動隱藏訊息。
badge: label="Alpha"
hide: true
hidefromtoc: true
