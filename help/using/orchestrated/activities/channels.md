...
**在此頁面上：**&#x200B;瞭解如何新增及設定電子郵件、簡訊、推播和直接郵件通道活動，以在Orchestrated行銷活動中傳送行銷或異動訊息。
...
>title="電子郵件活動"
>abstract="電子郵件活動讓您能在協調的行銷活動中傳送電子郵件，單次訊息和定期訊息兩者均適用。 此活動會自動執行傳送電子郵件至相同協調的行銷活動內計算的某個目標的流程。 您可以將管道活動結合至多步驟行銷活動畫布中，建立可根據客戶行為和資料觸發動作的跨管道行銷活動。"

>[!CONTEXTUALHELP]
>id="ajo_orchestration_sms"
>title="簡訊活動"
>abstract="SMS 活動讓您能在協調的行銷活動中傳送簡訊，單次訊息和定期訊息兩者均適用。 此活動可自動化流程，將簡訊傳送給在同一協調的行銷活動中計算出的目標。 您可以將管道活動與多步驟行銷活動畫布結合，建立可根據客戶行為和資料觸發動作的跨管道行銷活動。"

>[!CONTEXTUALHELP]
>id="ajo_orchestration_push"
>title="推播活動"
>abstract="推播活動讓您能在協調的行銷活動當中傳送推播。 推播活動可以傳送單次和定期之協調的行銷活動訊息，自動傳送推播至相同協調的行銷活動內預先定義的目標。 您可以將管道活動與行銷活動畫布結合，建立可根據客戶行為和資料觸發動作的跨管道行銷活動。"
...
>title="直接郵件活動"
>abstract="直接郵件活動讓您在協調的行銷活動中傳送直接郵件更加方便，單次訊息和定期訊息皆適用。 此類活動會自動化流程，產生直接郵件提供者所需的摘取檔案。 您可以將管道活動與協調的行銷活動畫布結合，建立可根據客戶行為和資料觸發動作的跨管道行銷活動。"

>[!CONTEXTUALHELP]
>id="ajo_orchestration_custom"
>title="自訂管道活動"
>abstract="「自訂管道」活動可讓您在協調的行銷活動內透過第三方系統或自訂整合來傳送訊息。 它可讓您透過將客群資料匯出至外部系統，以觸發外部傳遞程序，例如合作夥伴平台或專屬傳訊工具。 您可以將自訂管道活動與行銷活動畫布中的其他管道活動結合，以建立跨管道行銷活動來吸引原生和自訂接觸點的客戶。"
...
1. 在右邊欄中，使用&#x200B;**[!UICONTROL 類別]**&#x200B;欄位為此訊息選擇&#x200B;**[!UICONTROL 行銷]**&#x200B;或&#x200B;**[!UICONTROL 異動]**。 交易型訊息不需要選擇加入，且適合用於時效性強的通訊，例如中斷、緊急情況或取消。
...
使用&#x200B;**[!UICONTROL 動作追蹤]**&#x200B;區段，追蹤收件者對電子郵件或簡訊傳遞的反應。 執行行銷活動後，即可從行銷活動報告中存取追蹤結果。 [深入瞭解行銷活動報告](../../reports/campaign-global-report-cja.md)
...
### 新增個人化和條件式內容{#add-personalization}
...
為電子郵件傳遞建立條件式內容時，您可以使用行銷活動工作表中的&#x200B;**[!UICONTROL Target]**&#x200B;屬性。 這些屬性包括關聯式結構描述的傳入對象或擴充資料，因此您可以根據目標籤錄顯示不同的內容。 條件專屬於目前傳遞，無法儲存為可重複使用的條件。

➡️ [瞭解如何在電子郵件Designer](../../personalization/dynamic-content.md#emails)中建立條件式內容。
