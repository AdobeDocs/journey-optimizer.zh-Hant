...
![畫布中的可用活動清單](../assets/orchestrated-activities.png){width="80%"}
...
![目標定位活動清單](../assets/targeting-activities.png){width="40%"}
...
![流量控制活動清單](../assets/flow-control-activities.png){width="20%"}
