...
行銷人員可以在協調的行銷活動中，從一個資料實體變更為相關的資料實體，藉此增強客群目標定位。這可讓您超越使用者輪廓，並專注於特定行為，例如購買、預訂或其他互動。
...
1. 在您協調的行銷活動中新增&#x200B;**[!UICONTROL 變更維度]**&#x200B;活動。
...
接著，新增&#x200B;**[!UICONTROL 變更維度]**&#x200B;活動，以將目標維度從&#x200B;**[!UICONTROL 願望清單]**&#x200B;切換為&#x200B;**[!UICONTROL 收件者]。**&#x200B;此步驟會確保協調的行銷活動目標為連結至這些願望清單的正確輪廓，允許將簡訊傳送至預期的輪廓。
