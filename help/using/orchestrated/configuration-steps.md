...
1. 選取&#x200B;**上傳DDL檔案**&#x200B;以定義實體關聯圖並建立結構描述。
   ...
   表格結構必須包含：
   * 至少一個主索引鍵
   * 版本識別碼，例如`datetime`或`number`型別的`lastmodified`欄位。
