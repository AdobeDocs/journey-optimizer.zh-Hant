...
**[!UICONTROL 協調的行銷活動]**&#x200B;為此提供兩個主要結構描述：
...
回饋式重新目標定位規則可讓您根據&#x200B;**[!UICONTROL 訊息回饋]**&#x200B;結構描述中擷取的訊息傳遞事件，重新目標定位收件者。 這些事件包括已傳送、已開啟、已退回或標示為垃圾郵件的郵件等結果。

您可以使用此資料定義規則，識別收到先前訊息的收件者，以啟用根據特定傳遞狀態的後續通訊。

1. 建立新的&#x200B;**[!UICONTROL 協調的行銷活動]**。

1. 新增&#x200B;**[!UICONTROL 建置對象]**&#x200B;活動，並將目標維度設為&#x200B;**[!UICONTROL 收件者(caas)]**。 按一下&#x200B;**[!UICONTROL 繼續]**。

1. 若要快速開始，您可以使用內建的&#x200B;**[!UICONTROL 行銷活動回饋]**&#x200B;篩選器，根據訊息傳遞事件來鎖定收件者。

   +++ 詳細逐步說明

   1. 在&#x200B;**[!UICONTROL 規則產生器]**&#x200B;中，按一下&#x200B;**[!UICONTROL 選取或儲存篩選器]**，然後從清單中選擇&#x200B;**[!UICONTROL 行銷活動意見回饋]**。

   1. 選取篩選規則並選擇您要鎖定的&#x200B;**[!UICONTROL 行為]**，例如&#x200B;**[!UICONTROL 已傳送的訊息]**。

   1. 按一下![資料夾圖示](assets/do-not-localize/folder-search.svg)以選取您要重新定位的特定行銷活動。 您有兩個選項：

      * **[!UICONTROL 選取特定行銷活動]**：從清單中選擇特定行銷活動，以重新鎖定與該行銷活動互動的收件者。

      * **[!UICONTROL 來自轉換的行銷活動]**：參考您協調行銷活動中先前活動的行銷活動。

   +++

1. 或者，您也可以手動建置自訂規則。 在&#x200B;**[!UICONTROL 規則產生器]**&#x200B;中，按一下&#x200B;**[!UICONTROL 新增條件]**，然後從&#x200B;**[!UICONTROL 屬性選擇器]**&#x200B;中選取&#x200B;**[!UICONTROL 訊息回饋]**。 按一下&#x200B;**[!UICONTROL 確認]**&#x200B;建立&#x200B;**訊息回饋存在，例如**&#x200B;條件。
...
追蹤式重新目標定位規則會使用&#x200B;**[!UICONTROL 電子郵件追蹤]**&#x200B;結構描述的資料，根據收件者與訊息的互動來鎖定收件者。 它會擷取使用者動作，例如電子郵件開啟和連結點按。
...
1. 若要快速開始，您可以使用內建的&#x200B;**[!UICONTROL 行銷活動回饋]**&#x200B;篩選器，根據訊息傳遞事件來鎖定收件者。
   ...
   1. 選取篩選規則，然後選擇您要鎖定的&#x200B;**[!UICONTROL 行為]**，例如&#x200B;**[!UICONTROL 已開啟的訊息]**，或&#x200B;**[!UICONTROL 已點按的訊息]**。
...
1. 或者，您也可以手動建置自訂規則。 在&#x200B;**[!UICONTROL 規則產生器]**&#x200B;中，按一下&#x200B;**[!UICONTROL 新增條件]**，然後從&#x200B;**[!UICONTROL 屬性選擇器]**&#x200B;中選取&#x200B;**[!UICONTROL 電子郵件追蹤]**。
