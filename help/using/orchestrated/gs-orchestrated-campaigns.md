...
>title="協調的行銷活動概觀"
>abstract="<b>行銷活動協調</b><br/>分割、合併、擴充及操作關聯式資料集來定義您的客群<br/><br/> <b>利用多實體資料</b><br/>了解協調行銷活動如何利用關聯式資料集來擴充資料，以進行細分和個人化<br/><br/><b>臨時細分和精準計數</b><br/>利用精準計數逐步建置您的區段<br/><br/><b>可用頻道</b><br/>電子郵件、簡訊、推播通知"
