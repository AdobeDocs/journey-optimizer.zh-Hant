...
直接在iPhone Lock畫面和Dynamic Island上提供持續性的即時更新。 針對個別使用案例（訂單追蹤、騎行狀態）或廣播使用案例（運動分數、飛行狀態），從API觸發的行銷活動提供即時活動動力。

[進一步瞭解iOS Live活動](../mobile-live/get-started-mobile-live.md)
:::
...
瞭解如何透過Meta的Cloud API整合及使用WhatsApp訊息，以進行個人化和合規的通訊行銷活動和歷程。

[進一步瞭解WhatsApp傳訊](../../rp_landing_pages/whatsapp-landing-page.md)
:::
...
瞭解如何設定、建立及個人化LINE訊息，以便在行銷活動和歷程中有效溝通。

[進一步瞭解LINE傳訊](../../rp_landing_pages/line-landing-page.md)
:::
