...
您可以從此清單存取已發佈專案的[登陸頁面即時報告](../reports/lp-report-live.md)或[登陸頁面全域報告](../reports/lp-report-global.md)。
...
>additional-url="https://experienceleague.adobe.com/zh-hant/docs/journey-optimizer/using/landing-pages/landing-pages-design/design-lp" text="設計登陸頁面內容"
