...
1. 選取您要建立的登入頁面型別。
   ...
   * **[!UICONTROL 訂閱/取消訂閱]**：使用此型別建立訂閱或取消訂閱使用案例的登陸頁面。 [了解更多](lp-use-cases.md#subscription-to-a-service)
   * **[!UICONTROL 資料擷取]**：使用此型別建立資料擷取使用案例的登陸頁面。 [了解更多](get-started-lp.md#data-capture-lp)
...
>* 發佈之前，請檢查並解決所有警報。 [了解更多](#check-alerts)
