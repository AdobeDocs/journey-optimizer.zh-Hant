...
1. [設計電子郵件](../email/get-started-email-design.md) 以宣佈註冊現已開啟，您可以參加活動。

1. [插入連結](../email/message-tracking.md#insert-links) 內容。 選擇 **[!UICONTROL 登錄頁]** 的 **[!UICONTROL 連結類型]** 選擇 [登錄頁](create-lp.md#configure-primary-page) 為註冊而建立的。
...
1. 建立其他 [旅程](../building-journeys/journey.md)。 通過按一下 **[!UICONTROL 建立行程]** 按鈕 [了解更多](create-lp.md#configure-primary-page)

   ![](assets/lp_subscription-uc-create-journey.png)

1. 展開 **[!UICONTROL 事件]** 類別並刪除 **[!UICONTROL 段資格]** 活動到畫布中。 [了解更多](../building-journeys/segment-qualification-events.md)

1. 按一下 **[!UICONTROL 段]** ，然後選擇您建立的訂閱清單。
...
瞭解有關管理收件人同意的詳細資訊，以及為什麼在 [此部分](../privacy/opt-out.md)。
...
1. [設計](design-lp.md) 主要頁面內容：使用登錄頁特定 **[!UICONTROL 窗體]** 元件，定義 **[!UICONTROL 選擇退出]** 複選框，然後選擇更新 **[!UICONTROL 渠道（電子郵件）]**:在登錄頁上選中「選擇退出」框的配置檔案將被從您的所有通信中選擇。
...
1. 添加確認 [子頁](create-lp.md#configure-subpages) 顯示給提交表單的用戶。
   ...
   >[!NOTE]
   >
   >確保引用首頁中的子頁 **[!UICONTROL 行動要求]** 的下界 **[!UICONTROL 窗體]** 元件。 [了解更多](design-lp.md)

1. 配置和定義頁面內容後， [發佈](create-lp.md#publish) 登錄頁。

1. [建立電子郵件](../email/get-started-email-design.md) 在旅途中。

1. 選擇內容中的文字，並使用內容相關工具列[插入連結](../email/message-tracking.md#insert-links)。您還可以使用按鈕上的連結。

1. 選擇 **[!UICONTROL 登錄頁]** 從 **[!UICONTROL 連結類型]** 下拉清單，然後選擇 [登錄頁](create-lp.md#configure-primary-page) 你為退出而創造的。
...
若要檢查對應的設定檔選擇是否已更新，請前往 Experience Platform，並透過選取識別名稱空間和對應的識別值來存取設定檔。 在 [Experience Platform文檔](https://experienceleague.adobe.com/docs/experience-platform/profile/ui/user-guide.html?lang=zh-Hant){target="_blank"}。

![](assets/lp_opt-out-profile-choice.png)

在 **[!UICONTROL 屬性]** 頁籤，您可以看到 **[!UICONTROL 選擇]** 已更改為 **[!UICONTROL 不]**。

選擇退出資訊儲存在 **同意服務資料集**。 [在資料集上瞭解更多資訊](../data/get-started-datasets.md)

>[!NOTE]
>
>如果預設的合併方法 [Adobe Experience Platform](https://experienceleague.adobe.com/docs/experience-platform/profile/home.html?lang=zh-Hant){target="_blank"} **[!UICONTROL Profiles]** merge policy is **[!UICONTROL Dataset Precedence]**, make sure to enable the **[!UICONTROL AJO Consent Service Dataset]** and to prioritize it in the merge policy. [Learn more](https://experienceleague.adobe.com/docs/experience-platform/profile/merge-policies/ui-guide.html#dataset-precedence-profile){target="_blank"}
>
>即使沒有將批添加到此資料集，它仍將包含選擇加入/選擇退出資訊。
