...
**在此頁面上：**&#x200B;逐步說明使用登入頁面推動訂閱、擷取退出，以及觸發表單提交中的後續歷程的實用範例。
...
若要這麼做，您必須根據包含提交資訊的&#x200B;**[!UICONTROL AJO電子郵件追蹤體驗事件結構描述]**，建立[規則型單一事件](../event/about-creating.md)，並[在歷程中使用此事件](../building-journeys/general-events.md)。
