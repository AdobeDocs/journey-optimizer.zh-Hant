...
瀏覽[完整API參考](https://developer.adobe.com/journey-optimizer-apis/){target="_blank"}以存取所有Journey Optimizer API並直接測試它們。 若要開始，請確定[設定驗證](https://developer.adobe.com/journey-optimizer-apis/references/authentication/){target="_blank"}以收集必要的認證。
...
* [整合Adobe Analytics](../integrations/integration-ajo-analytics.md)
* [整合Adobe Target](../integrations/integration-ajo-target.md)
