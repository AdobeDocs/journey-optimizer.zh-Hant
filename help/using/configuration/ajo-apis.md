...
>* **[Experience Decisioning API](../experience-decisioning/api-reference/getting-started.md)** — 以程式設計方式管理決定專案、選取策略和適用性規則
...
進一步瞭解[Experience Decisioning API參考](../experience-decisioning/api-reference/getting-started.md)
