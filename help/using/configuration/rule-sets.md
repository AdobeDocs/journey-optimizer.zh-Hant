...
除了此「全域預設規則集」規則集外，您還可以建立可套用至任何促銷活動的&#x200B;**自訂規則**&#x200B;集，以限制在該促銷活動中傳送的訊息數。 [瞭解如何建立自訂規則集](#create)

![](assets/rule-sets-default.png)

>[!IMPORTANT]
>
>目前，自訂規則集只能套用至&#x200B;**行銷活動**。 只有「全域預設規則集」規則集中定義的規則適用於歷程和行銷活動通訊。
...
1. 您可以在[全域報告](../reports/global-report.md)和[即時報告](../reports/live-report.md)中檢視從傳送中排除的設定檔數目，其中頻率規則會列為使用者從傳送中排除的可能原因。
