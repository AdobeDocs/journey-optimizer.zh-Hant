...
**在此頁面上：**&#x200B;瞭解什麼是DMARC、其原則如何運作，以及如何直接在Adobe Journey Optimizer中為您委派的子網域設定和管理DMARC記錄。
...
* 當&#x200B;**將任何新子網域**&#x200B;委派給Adobe時，您可以&#x200B;**直接在[!DNL Journey Optimizer]管理介面中設定DMARC**。 [了解作法](#set-up-dmarc)
...
1. 您可以選擇新增一或多個您選擇的電子郵件地址，以指出電子郵件中[驗證失敗](#how-dmarc-works)的&#x200B;**DMARC報告**&#x200B;應該位於貴組織內的哪個位置。 您最多可以為每個報表新增5個地址。

   >[!NOTE]
   >
   >* 請確定您的控制中有正版收件匣（而非Adobe）可接收這些報表。
   >* 這些高度技術性的報告提供企圖詐騙且最好透過協力廠商工具消化的電子郵件概觀。
