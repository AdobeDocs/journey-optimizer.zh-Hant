...
# 建立IP集區 {#create-ip-pools}

>[!CONTEXTUALHELP]
>id="ajo_admin_ip_pool_header"
>title="設定IP集區"
>abstract="IP集區會收集子網域的IP位址，以提升電子郵件傳遞能力。"

>[!CONTEXTUALHELP]
>id="ajo_admin_ip_pool"
>title="設定IP集區"
>abstract="您可以使用Journey Optimizer建立IP集區，將子網域的IP位址群組在一起。 這可能會顯著改善您的電子郵件傳遞能力，因為這麼做可防止子網域信譽影響您的其他子網域。"
...
1. 從下拉式清單中選取要包含在集區中的IP位址，然後按一下&#x200B;**[!UICONTROL 提交]**。 清單中提供您執行個體布建的所有IP位址。
...
1. 視需要編輯其屬性。 您可以修改說明，並新增或移除IP位址。 請注意，無法編輯IP集區名稱 — 若要重新命名，請刪除集區並建立新的集區。

   ![](assets/ip-pool-edit.png)

   >[!CAUTION]
   >
   >在考慮刪除IP時請格外小心，因為這將對其他IP造成額外負載，並可能對您的傳遞能力產生嚴重影響。 如有疑問，請聯絡傳遞能力專家。
...
>[!NOTE]
>
>* 當[建立通道設定](channel-surfaces.md#create-channel-surface)時，如果您選取從未與選取的子網域關聯且處於&#x200B;**[!UICONTROL 處理]**&#x200B;狀態的IP集區，您將無法繼續建立設定。 [進一步瞭解](channel-surfaces.md#create-channel-surface)
>* 成功更新IP集區後，請等幾分鐘讓即時訊息生效，或等候批次訊息產生下一個批次工作。
