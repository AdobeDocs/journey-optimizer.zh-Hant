...
>[!NOTE]
>
>* 當[建立通道設定](channel-surfaces.md#create-channel-surface)時，如果您選取從未與選取的子網域關聯且處於&#x200B;**[!UICONTROL 處理]**&#x200B;狀態的IP集區，您將無法繼續建立設定。 [了解更多](channel-surfaces.md#create-channel-surface)
