...
>[!NOTE]
>
>[!DNL Journey Optimizer]不支援SMS封存需求。 如需專屬的封存支援，請與您的SMS供應商（Synch、Infobip或Twilio）合作。
...
若要啟用&#x200B;**[!UICONTROL 密件副本電子郵件]**&#x200B;選項，請在[頻道介面](channel-surfaces.md)的專用欄位中輸入您選擇的電子郵件地址（即訊息預設集）。 您可以指定正確格式的任何外部地址，但委派給Adobe的子網域上定義的電子郵件地址除外。 例如，如果您將&#x200B;*marketing.luma.com*&#x200B;子網域委派給Adobe，則禁止任何類似&#x200B;*abc@marketing.luma.com*&#x200B;的位址。
...
1. 對於以下所有其他查詢，您將需要歷程動作ID。 執行此查詢來擷取過去2天內與特定歷程版本ID相關聯的所有動作ID：
   ...
   >[!NOTE]
   >
   >若要取得`<journey version id>`引數，請從&#x200B;**[!UICONTROL 歷程管理]** > **[!UICONTROL 歷程]**&#x200B;功能表選取對應的[歷程版本](../building-journeys/journey.md#journey-versions)。 歷程版本ID會顯示在網頁瀏覽器中顯示的URL結尾。
   >
