...
>[!NOTE]
>
>根據預設， [!DNL Journey Optimizer] 授權合約可讓您委派最多10個子網域。 如果您想要提高此限制，請聯絡您的Adobe聯絡人。
...
1. 如果子網域沒有DMARC記錄，您可以在此處設定它們。 如果子網域有現有的DMARC記錄，而且這些記錄是由擷取 [!DNL Journey Optimizer]，您可使用相同的值，或視需要加以變更。 更多詳情
