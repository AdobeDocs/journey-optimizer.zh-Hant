...
1. 轉到 **[!UICONTROL 頻道]** > **[!UICONTROL 電子郵件配置]** > **[!UICONTROL 隱藏清單]**。

1. 選擇 **[!UICONTROL 編輯禁止顯示規則]** 按鈕
...
瞭解如何在中建立通道曲面時調整電子郵件重試參數 [此部分](../email/email-settings.md#email-retry)。
