...
以[!DNL Intelligent Services]為基礎的[!DNL Adobe Experience Platform]可提供客戶體驗團隊的AI-as-a-service。 它有助於預測客戶行為、衡量行銷活動影響以及改善投資報酬率。 如需詳細資訊，請參閱[[!DNL Adobe Experience Platform] 檔案](https://experienceleague.adobe.com/docs/experience-platform/intelligent-services/home.html){target="_blank"}。
