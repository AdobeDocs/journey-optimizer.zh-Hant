...
**在此頁面上：**&#x200B;瞭解如何使用Adobe Journey Optimizer中的歷程儀表板、清單和行事曆檢視，來瀏覽、搜尋和篩選您的歷程。
...
>[!NOTE]
>
>* 歷程編寫生命週期也包含一組無法篩選的中間狀態： **發佈** （介於「草稿」和「即時」之間）、**啟用測試模式**&#x200B;或&#x200B;**停用測試模式** (介於&#x200B;**草稿**&#x200B;和&#x200B;**草稿（測試）**&#x200B;之間)、**停止** （介於&#x200B;**即時**&#x200B;和&#x200B;**已停止**&#x200B;之間）、**繼續** （介於&#x200B;**之間）已暫停**&#x200B;和&#x200B;**Live**)，**正在暫停** （介於&#x200B;**Live**&#x200B;和&#x200B;**Paused**&#x200B;之間）當歷程處於中間狀態時，它是只讀的。
>
>* 如果您需要修改為&#x200B;**即時**&#x200B;歷程，請[建立歷程的新版本](#journey-versions)。 您也可以暫停即時歷程、執行所有需要的變更，並隨時重新繼續。 [進一步瞭解暫停歷程](../building-journeys/journey-pause.md)
...
從歷程清單中，您可以使用核取方塊一次選取多個專案，並從畫面底部出現的大量動作列將作業套用至所有專案。

![已選取多個歷程的大量動作列](assets/bulk-actions-journeys.png)

可進行下列操作：

* **[!UICONTROL 新增到封裝]** — 將選取的歷程匯出到另一個沙箱。 [瞭解如何匯出物件 →](../configuration/copy-objects-to-sandbox.md)
* **[!UICONTROL 移至資料夾]** — 將選取的歷程移至資料夾。 [瞭解如何使用資料夾→](#journeys-folders)
* **[!UICONTROL 編輯標籤]** — 編輯指派給所選歷程的標籤。 [瞭解如何使用標籤 →](../start/search-filter-categorize.md#add-tags)
* **[!UICONTROL 管理存取權]** — 將存取權標籤套用至選取的歷程。 [深入瞭解物件層級存取控制 →](../administration/object-based-access.md)
* **[!UICONTROL 刪除]** — 永久刪除選取的歷程。
* **[!UICONTROL 暫停]** — 暫停選取的&#x200B;**即時**&#x200B;歷程（_大量暫停_）。 只有在選取&#x200B;**即時**&#x200B;歷程時才可用。
* **[!UICONTROL 繼續]** — 繼續選取的&#x200B;**已暫停**&#x200B;個歷程（_大量繼續_）。 只有在選取&#x200B;**已暫停**&#x200B;歷程時才可用。

![從底部列大量暫停兩個即時歷程](assets/bulk-pause-journeys.png)

[進一步瞭解暫停/繼續歷程](journey-pause.md)。 [深入瞭解其他大量動作→](../start/search-filter-categorize.md#bulk-actions)
