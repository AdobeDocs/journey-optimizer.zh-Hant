...
**在此頁面上：**&#x200B;瞭解 Adobe Journey Optimizer 中歷程的基礎知識，包括歷程類型、設計工作流程、重要功能，以及建立個人化客戶體驗的最佳做法。
...
[選擇驗證方法→](choose-validation-method.md) | [測試您的歷程→](testing-the-journey.md) | [了解試用→](journey-dry-run.md)
...
在上線之前，使用測試設定檔驗證歷程，並使用真實的生產資料預覽執行，而不傳送通訊或更新設定檔。
