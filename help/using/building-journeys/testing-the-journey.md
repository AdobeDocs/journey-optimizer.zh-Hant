...
當您想要使用已在Adobe Experience Platform中建立的現有測試設定檔來測試您的歷程時，請使用&#x200B;**[!UICONTROL 測試模式]**&#x200B;方法。

1. 若要啟動測試模式，請按一下&#x200B;**[!UICONTROL 模擬]**&#x200B;按鈕，然後選取&#x200B;**[!UICONTROL 測試模式]**。
...
>[!NOTE]
>
>* 當您在測試模式中觸發事件時，會產生實際事件，這表示它也會點選接聽此事件的其他歷程。
>
...
目前顯示在歷程中的個人（技術上稱為執行個體）數量。 系統會針對每個個人顯示下列資訊：
