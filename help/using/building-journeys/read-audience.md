...
## 有關「閱讀客群」活動 {#about-segment-trigger-actvitiy}
...
1. 在&#x200B;**[!UICONTROL 對象]**&#x200B;欄位中，選擇將進入歷程的Adobe Experience Platform對象，然後按一下&#x200B;**[!UICONTROL 儲存]**。 您可以選取使用[區段定義](../audience/creating-a-segment-definition.md)產生的任何Adobe Experience Platform對象。
   ...
   >[!NOTE]
   >
   >此外，您也可以鎖定使用從CSV檔案[&#128279;](https://experienceleague.adobe.com/docs/experience-platform/segmentation/ui/overview.html?lang=zh-Hant#import-audience){target="_blank"}上傳的[對象組合](../audience/get-started-audience-orchestration.md)或建立的Adobe Experience Platform對象。
...
>title="全新客群評估的等待時間"
>abstract="指定歷程將等待批次客群進行全新評估的時間長度。等待期限制為整數值，可以指定以分鐘或小時為單位，且必須介於 1 至 6 小時之間。"
