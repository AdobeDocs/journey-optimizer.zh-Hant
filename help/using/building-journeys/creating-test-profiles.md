...
Test配置檔案在使用 [test模式](../building-journeys/testing-the-journey.md) 在旅途中， [預覽和test內容](../messages/preview.md)。
...
一個簡單的方法是使用 **[!UICONTROL Update Profile]** 行程中的操作活動並更改 **測試配置檔案** 布爾欄位，從false到true。
