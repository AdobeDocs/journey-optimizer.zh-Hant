...
**動作**&#x200B;活動是歷程畫布中所有管道動作的單一進入點。

它取代了先前的個別內建頻道活動，並將電子郵件、推播、簡訊、應用程式內、網路、程式碼型體驗和內容卡整合為單一統一活動型別。
...
1. 根據所選管道設定您的活動。 以下連結提供詳細的設定指南。
   ...
   * 瞭解建立傳出動作的詳細步驟，如下所示：
     ...
     <table style="table-layout:fixed">
      ...
      <div>
      <a href="../mobile/create-mobile-message.md"><strong>建立文字訊息（簡訊/多媒體簡訊）</strong></a>
      </div>
      <p>
      </td>
      </tr>
