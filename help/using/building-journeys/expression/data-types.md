...
您也可以傳遞傳遞epoch值的整數。 [閱讀全文](https://www.epochconverter.com)
...
Duration.parse：接受的格式是以ISO-8601期間格式PnDTnHnMn.nS為基礎，天數被視為剛好24小時。 [了解更多](https://docs.oracle.com/javase/8/docs/api/java/time/Duration.html#parse-java.lang.CharSequence-)
