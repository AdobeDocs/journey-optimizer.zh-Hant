...
使用 **[!UICONTROL 更新配置檔案]** 操作活動，用來自事件、資料源或具有特定值的資訊更新現有Adobe Experience Platform配置檔案。
...
只有測試設定檔才能進入旅程測試模式。您可以建立新的test配置檔案或將現有配置檔案轉換為test配置檔案。 在Adobe Experience Platform，可以通過csv檔案導入或API調用更新配置檔案屬性。 更簡單的方法是 **更新配置檔案** 操作活動，並將test配置檔案布爾欄位從false更改為true。
