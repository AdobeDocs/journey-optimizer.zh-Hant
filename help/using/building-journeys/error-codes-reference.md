...
| 錯誤碼 | 說明 | 根本原因 | 解決方法 |
|------------|-------------|-----------|-----------|
| **CJMRT-110001-500** | 超過工作流程步驟的最大執行次數（例如IP相似性布建步驟逾時） | 工作流程/布建工作未在允許的重試/時間內完成，通常是因為基礎架構/服務延遲或暫時性後端問題 | 1.請稍後再試<br/>2。 檢查[Adobe Status](https://status.adobe.com/zh-tw/)是否有中斷情形<br/>3。 透過工作流程/工作/組織詳細資訊<br/>4向上呈報至Adobe支援。 提供記錄檔和網路擷取（若有）<br/><br/>**相關檔案**： [歷程疑難排解](troubleshooting.md) |
