...
**在此頁面上：**&#x200B;瞭解如何使用及設定對象資格事件，以在設定檔符合或退出Adobe Experience Platform對象資格時，觸發歷程進入或進展。
...
請參閱[條件](../building-journeys/conditions.md#about_condition)。
...
>[!CAUTION]
>
>**淘汰通知 — 2026年9月**：自&#x200B;**2026年9月**&#x200B;起，Journey Optimizer將封鎖在&#x200B;**對象資格**&#x200B;節點中使用批次對象之任何歷程的發佈。 現有的即時歷程不受影響。 使用此設定的新歷程、草稿歷程和重複歷程必須在2026年9月之前更新。 [了解如何移轉您的歷程](aq-batch-audiences-migration.md)
