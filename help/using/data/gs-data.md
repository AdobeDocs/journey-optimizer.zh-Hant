...
* **[設定資料概觀教學課程](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/set-up-data-overview){target="_blank"}** — Journey Optimizer中資料設定的入門友善影片逐步解說，涵蓋結構描述、資料集和來源，從頭到尾。

* **[建立資料集並擷取資料教學課程](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/data-management/create-datasets-and-ingest-data){target="_blank"}** — 一個實作教學課程，說明如何在Adobe Experience Platform中建立資料集並使用來源聯結器擷取資料，提供您可以在自己的沙箱中遵循的逐步指示。
