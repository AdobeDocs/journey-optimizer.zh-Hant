...
您也可以使用&#x200B;**決策**，將最相關的選件提供給每位訪客。 在個人化編輯器中，導覽至&#x200B;**[!UICONTROL 決定原則]**，並選取&#x200B;**[!UICONTROL 插入語法]**&#x200B;以將決定原則新增至網頁元件。 [了解更多](../experience-decisioning/use-decision-policy.md)
...
>title="使用瀏覽模式"
>abstract="在此模式下，您可以從選取的設定導覽至要個人化的確切頁面。"
