...
一旦您的行銷活動上線，您可以檢查行銷活動報告的&#x200B;**[!UICONTROL 網頁]**&#x200B;索引標籤，以比較曝光次數、點按率及與網頁的互動次數等元素。 進一步瞭解行銷活動網站[即時報告](../reports/campaign-live-report.md#web-tab)和[全域報告](../reports/campaign-global-report.md#web-tab)。
