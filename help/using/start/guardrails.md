...
* 在任何一次，所有即時和已關閉歷程中最多可參考&#x200B;**25**&#x200B;個歷程的單一事件。 當達到此限制時，將封鎖使用該事件的任何其他發佈歷程。
* 單一XDM結構描述一次最多可由所有即時和已關閉歷程中的&#x200B;**100**&#x200B;個事件參考。 當達到此限制時，會封鎖任何包含參照該結構描述的事件節點的發佈歷程。
...
* 客群資格鑑定歷程不支援補充識別碼。
* 沙箱在所有即時和已關閉歷程中最多可包含&#x200B;**300**&#x200B;個對象資格節點。 當達到此限制時，會封鎖具有其他對象資格節點的發佈歷程。
