...
* **AI支援的傳送時間最佳化**：讓AI根據其歷史參與模式，預測每個客戶的最佳傳送時間，將開啟及點按率提高最多10%。 [瞭解傳送時間最佳化](../../building-journeys/send-time-optimization.md)

* **Multi-Armed Bandit實驗**：在測試時，自動分配更多流量以即時取得成功變化，無需等待測試完成，即可最大化結果。 [瞭解實驗](../../content-management/content-experiment.md)

* **核准工作流程**：在行銷活動和歷程上線之前，實作其稽核流程（可搭配其他授權使用）。 [瞭解核准](../../test-approve/gs-approval.md)
