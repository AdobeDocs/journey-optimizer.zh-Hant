...
* **Personalization** — 在Personalization編輯器中，產生新運算式、說明現有程式碼，或修正AI助理的問題。 適用於Personalization運算式的[AI小幫手](../content-management/generative-personalization-expressions.md)
...
[深入瞭解用於決策的AI模型](../experience-decisioning/ranking/ai-models.md) | [建立AI排名模型](../experience-decisioning/ranking/create-ai-models.md)
