...
**客戶** — 管理對象和設定檔
* **對象** — 建立和管理客戶區段。 [使用對象](../audience/about-audiences.md)
* **訂閱清單** — 管理選擇加入清單。 [管理訂閱](../landing-pages/subscription-list.md)
* **設定檔** — 檢視整合式客戶設定檔。 [探索設定檔](../audience/get-started-profiles.md)
* **身分** — 管理身分解析。 [瞭解身分](../audience/get-started-identity.md)

**隱私權** — 控制隱私權與法規遵循。 [隱私權概觀](../privacy/get-started-privacy.md)
* **原則** — 定義資料治理原則
