...
* **[!UICONTROL 歷程]**  — 建立、設定和協調您的客戶歷程。 [了解更多](../building-journeys/journey-gs.md#jo-build)

* **[!UICONTROL 登錄頁面]**  — 建立、設計、測試和發佈登錄頁面。 [了解更多](../landing-pages/get-started-lp.md)
...
* 然後按一下您電子郵件地址下方顯示的語言
* 選擇您偏好的語言，然後按一下 **「儲存」**。您可以選取第二種語言，以備您使用的元件未以第一種語言本地化時使用。
