...
* **內容與選件** — 建立、管理及個人化內容的工具；為每個人選取最佳選件的即時邏輯。 [設計內容](../../rp_landing_pages/content-management-landing-page.md) | [管理優惠方案](../offers/get-started/starting-offer-decisioning.md)
...
| **內容管理** | 建立個人化訊息 | 設計電子郵件、管理資產、建立範本和片段、個人化內容。 [進一步了解](../../rp_landing_pages/content-management-landing-page.md) |
