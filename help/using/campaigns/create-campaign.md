...
若要建立新促銷活動，請存取 **[!UICONTROL Campaigns]** ，然後按一下 **[!UICONTROL Create campaign]**. 您也可以複製現有的即時促銷活動以建立新促銷活動。 [深入了解](modify-stop-campaign.md#duplicate)
...
1. 在 **[!UICONTROL Properties]** 區段，指定您要如何執行促銷活動。 可用的促銷活動有兩種類型：
...
1. 在 **[!UICONTROL Actions]** 區段中，選擇要用來傳送訊息的通道和通道表面。
...
1. 按一下 **[!UICONTROL Create]** 來建立促銷活動。
...
您可以定義應傳送促銷活動訊息的頻率。 若要這麼做，請使用 **[!UICONTROL Action triggers]** 選項，以指定促銷活動應按日、每週或每月執行。

如果您不想在促銷活動啟動後立即執行，您可以使用 **[!UICONTROL Campaign start]** 選項。 此 **[!UICONTROL Campaign end]** 選項可讓您指定循環促銷活動何時應停止執行。
