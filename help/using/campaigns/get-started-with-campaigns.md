...
>title="行銷活動"
>abstract="建立您的細分流程、精心製作跨管道訊息，並規劃您的行銷活動。支援的頻道：電子郵件、簡訊、推播通知、直接郵件。"
...
>title="行銷活動"
>abstract="傳送一次性或定期的傳出交易型動作。 支援的管道：電子郵件、SMS、推播。"
...
* **您將會使用哪些管道？**(電子郵件、推播、簡訊、應用程式內、網頁等) → [依行銷活動類型檢視支援的管道](../channels/gs-channels.md#channels)
