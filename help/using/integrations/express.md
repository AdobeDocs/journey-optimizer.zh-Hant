...
>abstract="透過Adobe Express整合，開始個人化您的資產。 此功能可讓您調整影像大小、移除背景、裁切視覺效果，以及將資產轉換為JPEG或PNG。"
...
若要進一步瞭解Adobe Express，請參閱[本檔案](https://helpx.adobe.com/express/user-guide.html)。
