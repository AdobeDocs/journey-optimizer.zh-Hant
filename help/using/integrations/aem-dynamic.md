...
>[!IMPORTANT]
>
>請確定Adobe Experience Manager as a Cloud Service已啟用Dynamic Media with OpenAPI。 [深入瞭解](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis){target="_blank"}。
