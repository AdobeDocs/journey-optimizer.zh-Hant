...
>[!IMPORTANT]
>
>請確定Adobe Experience Manager as a Cloud Service已啟用Dynamic Media with OpenAPI。 [深入瞭解](https://experienceleague.adobe.com/zh-hant/docs/experience-manager-cloud-service/content/assets/dynamicmedia/dynamic-media-open-apis/dynamic-media-open-apis-overview#enable-dynamic-media-open-apis){target="_blank"}。
...
1. 調整影像引數（例如高度、寬度、旋轉、翻轉、亮度、色相等） 以符合您的資產需求。
...
1. 條件式內容可套用至Dynamic Media元件，以產生不同的內容變體。 [進一步瞭解](../personalization/dynamic-content.md)
