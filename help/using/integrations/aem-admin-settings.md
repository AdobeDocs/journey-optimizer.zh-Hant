...
1. 請在下方的下拉式清單中選擇您的設定：
   ...
   依預設，每個&#x200B;**[!DNL Adobe Experience Manager as a Cloud Service]**&#x200B;存放庫都設定為使用&#x200B;**發佈**&#x200B;執行個體。 您可以繼續內容片段測試步驟，而不變更這些設定。

   如果您的發佈執行個體已通過&#x200B;**驗證**，或您必須使用自訂發佈網域，請遵循下列步驟。

   1. 選取&#x200B;**[!UICONTROL 發佈執行個體設定]**&#x200B;以開啟發佈執行個體設定。

      ![](assets/aem-admin-settings-4.png)

   1. 啟用&#x200B;**[!UICONTROL 將Token傳送至發佈執行個體]**，以便服務認證包含在發佈執行個體的要求中。
