...
**在此頁面上：**&#x200B;瞭解如何將GenStudio for Performance Marketing與Journey Optimizer整合，以匯出電子郵件範本、產生品牌內內容變數，以及匯入回以用於您的電子郵件行銷活動。
...
[!DNL GenStudio for Performance Marketing]與[!DNL Journey Optimizer]之間的整合支援各種行銷情境：
