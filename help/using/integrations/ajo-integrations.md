...
[![了解更多](../assets/do-not-localize/learn-more-button.svg)](aem-fragments.md)
...
## Adobe智慧型服務 {#integration-intelligent-service}
...
## 透過MCP的AI工具(Beta) {#integration-mcp}

[!DNL Adobe Journey Optimizer]提供模型內容通訊協定(MCP)伺服器，可讓您直接從MCP相容的AI工具（例如Claude Web和Claude Desktop）使用純語言提示來查詢促銷活動及提供資料，而不需撰寫API呼叫或導覽產品熒幕。

深入瞭解[Journey Optimizer + MCP](../integrations/ajo-mcp.md)。
