...
# 建立多語言內容 {#multilingual-automated}
...
1. 按一下 **[!UICONTROL 新增地區]** 當您完成將Target地區設定連結到正確的翻譯提供者時。

1. 按一下 **[!UICONTROL 儲存]** 設定您的翻譯專案時。

1. 從翻譯專案的進階功能表中，您可以選擇編輯、停用或刪除它。
...
1. 從 **[!UICONTROL 翻譯專案]** 欄位，按一下 **[!UICONTROL 編輯]** 並選擇您先前建立的 **[!UICONTROL 翻譯專案]**.
   ...
   您先前設定的地區設定會自動匯入。 如果您更新 **[!UICONTROL 翻譯專案]**，按一下 **[!UICONTROL 重新整理]** 以反映這些變更 **[!UICONTROL 語言設定]**.
