...
title: 使用 AI 助理產生電子郵件
description: 開始使用AI助理產生電子郵件內容和資產
...
使用AI Assistant可製作完整的電子郵件、量身打造的文字片段和自訂影像，直接與您的對象交談、促進參與和互動，進而提升行銷活動的有效性。
...
在下列範例中，我們將運用AI助理來調整現有的電子郵件範本。

1. 建立和設定電子郵件行銷活動後，按一下 **[!UICONTROL 編輯內容]**.

   有關如何設定電子郵件促銷活動的詳細資訊，請參閱 [此頁面](../campaigns/create-campaign.md).

1. 視需要個人化您的電子郵件，並存取 **[!UICONTROL AI助理]** 功能表。

   ![](assets/full-email-1.png){zoomable=&quot;yes&quot;}

1. 啟用 **[!UICONTROL 使用原始內容]** 「AI助理」的選項，用來根據行銷活動內容、名稱和選取的對象來個人化新內容。
...
1. 您可以切換 **[!UICONTROL 主旨列]** 和 **[!UICONTROL 預覽文字]** 選項以將它們包含在變體生成中。
...
1. 建立和設定電子郵件行銷活動後，按一下 **[!UICONTROL 編輯內容]**.
   ...
   有關如何設定電子郵件促銷活動的詳細資訊，請參閱 [此頁面](../email/create-email.md).
...
1. 填入 **[!UICONTROL 基本詳細資訊]** 用於您的行銷活動。 完成後，按一下 **[!UICONTROL 編輯電子郵件內容]**.
...
1. 啟用 **[!UICONTROL 參考樣式]** AI助理根據參考內容個人化新內容的選項。 您也可以上傳影像以將內容新增至您的變數。
