...
title: 使用AI助理產生文字
description: 瞭解如何使用Journey Optimizer中的AI助理產生文字內容。
...
**在此頁面上：**&#x200B;瞭解如何使用AI助理產生、調整及完成品牌內文字內容，以用於Adobe Journey Optimizer中的電子郵件、網路、登陸頁面、推播通知和簡訊頻道。
...
1. 選取&#x200B;**[!UICONTROL 文字元件]**&#x200B;以僅鎖定特定內容，並存取&#x200B;**[!UICONTROL AI小幫手]**&#x200B;功能表（或&#x200B;**[!UICONTROL 顯示網頁的AI小幫手]**）。
   ...
   ![使用AI助理功能表選取的文字元件已開啟](assets/text-genai-1.png){zoomable="yes"}
...
1. 說明您要在&#x200B;**[!UICONTROL 提示]**&#x200B;欄位中產生的內容，以微調內容。
   ...
   ![具有提示欄位和品牌選擇器的AI助理文字產生面板](assets/text-genai-2.png){zoomable="yes"}
