...
title: 使用 AI 產生文字
description: 瞭解如何在Journey Optimizer中使用「產生內容」產生文字內容。
...
# 使用 AI 產生文字 {#generative-text}

>[!BEGINSHADEBOX]

**在此頁面上：**&#x200B;瞭解如何使用「產生電子郵件、網頁、登陸頁面、推播通知和Adobe Journey Optimizer簡訊通道的內容」來產生、調整及完成品牌內文字內容。
...
使用AI產生吸引人的文字內容，引起觀眾的共鳴。 無論您是需要增強電子郵件復本、建立吸引人的網頁內容、製作有說服力的登陸頁面文字、撰寫推播通知訊息，或撰寫SMS訊息，產生內容都可以協助您傳送具影響力的文字。

## 適用於電子郵件與網路頻道 {#email-web-channels}

「產生內容」可以為您的電子郵件行銷活動、網頁體驗和登入頁面產生高品質的文字內容。 此功能可讓您建立引人入勝的品牌內傳訊功能，透過數位接觸點與您的對象連結。

### 存取及設定 {#access-configure}

開始使用「產生內容」產生文字內容之前，您需要設定行銷活動或歷程並存取內容編輯器。 請依照下列步驟準備您的工作區，並開啟「產生內容」面板。
...
1. 選取&#x200B;**[!UICONTROL 文字元件]**&#x200B;以僅鎖定特定內容，並存取&#x200B;**[!UICONTROL 產生內容]**&#x200B;功能表（或&#x200B;**[!UICONTROL 顯示產生網頁內容]**）。

   ![選取的文字元件已開啟[產生內容]功能表](assets/text-genai-1.png){zoomable="yes"}

### 產生文字 {#generate-content}

瞭解如何使用「產生內容」製作清晰的提示、微調設定，以及產生量身打造的文字，確保您的訊息符合您的品牌和溝通目標。
...
1. 說明您要在&#x200B;**[!UICONTROL 提示]**&#x200B;欄位中產生的內容，以微調內容。
   ...
   ![使用[提示]欄位和[品牌選取器]產生[內容]文字產生面板](assets/text-genai-2.png){zoomable="yes"}
...
1. 使用&#x200B;**[!UICONTROL 文字設定]**&#x200B;選項量身打造您的提示：
   ...
   * **[!UICONTROL 音調]**：音調應該會與您的對象產生共鳴。 無論您是要提供豐富資訊、好玩或有說服力，「產生內容」都能據以調整訊息。
   ...
   ![展開文字設定，顯示選項](assets/text-genai-4.png){zoomable="yes"}

1. 從&#x200B;**[!UICONTROL 品牌資產]**&#x200B;功能表，按一下&#x200B;**[!UICONTROL 上傳品牌資產]**&#x200B;以新增任何品牌資產，該品牌資產包含可提供額外內容以產生內容或選取先前上傳內容的內容。
...
1. 按一下百分比圖示可檢視您的&#x200B;**[!UICONTROL 品牌一致性分數]**，並識別與您的品牌之間的任何不一致性。
   ...
   ![產生的文字變化與品牌對齊分數](assets/text-genai-6.png){zoomable="yes"}
...
1. 導覽至&#x200B;**[!UICONTROL 預覽]**&#x200B;視窗中的&#x200B;**[!UICONTROL 調整]**&#x200B;選項，以存取其他自訂功能：
   ...
   * **[!UICONTROL 變更通訊策略]**：根據您的目標修改傳訊方式，例如建立緊急狀態或強調令人興奮的吸引力。
   ...
   ![調整選項功能表](assets/text-genai-5.png){zoomable="yes"}
...
產生內容可為您的推播通知和SMS訊息產生吸引人的文字內容，協助您建立吸引人的行動通訊，在所有行動接觸點與受眾產生共鳴。

### 存取及設定 {#mobile-access-configure}

開始使用「產生行動裝置內容」產生文字之前，您必須設定行銷活動並存取「產生內容」。 存取方法會因推播通知和SMS訊息而略有不同。

1. 建立及設定您的行動裝置行銷活動：
   * **推播通知**：建立並設定您的推播通知行銷活動後，請按一下&#x200B;**[!UICONTROL 編輯內容]**。 [了解更多](../push/create-push.md)
   * **簡訊**：建立並設定簡訊行銷活動後，請按一下&#x200B;**[!UICONTROL 編輯內容]**。 [了解更多](../mobile/create-mobile-message.md)

1. 填寫行銷活動的&#x200B;**[!UICONTROL 基本詳細資料]**。 完成後，按一下&#x200B;**[!UICONTROL 編輯內容]**。

1. 視需要個人化您的訊息：
   * **推播通知**： [深入瞭解](../push/design-push.md)
   * **簡訊**： [深入瞭解](../mobile/create-mobile-message.md)
...
存取「產生內容」後，您可以進行產生設定，以建立符合您品牌和促銷活動目標的行動內容。 自訂文字引數、新增品牌資產，並提供提示以引導AI產生相關變數。
