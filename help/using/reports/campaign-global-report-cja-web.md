...
title: 行銷活動報告
description: 瞭解如何使用Campaign報告中的網頁資料
feature: Reporting
...
# 網頁行銷活動報告 {#campaign-global-report-cja-web}

>[!BEGINSHADEBOX]

**在此頁面上：**&#x200B;瞭解如何在Adobe Journey Optimizer中閱讀網路行銷活動報告，以分析您網頁的曝光次數和點選趨勢、追蹤資料和追蹤連結。

>[!ENDSHADEBOX]

>[!BEGINSHADEBOX]

您可以按一下行銷活動中的&#x200B;**[!UICONTROL 報告]**&#x200B;按鈕，然後選取&#x200B;**[!UICONTROL 檢視所有時間報告]**，以存取您的網站行銷活動報告。 [了解更多](report-gs-cja.md)
