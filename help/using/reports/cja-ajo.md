...
1. [使用您要傳送至Adobe Experience Platform的](https://experienceleague.adobe.com/docs/analytics-platform/using/cja-connections/create-connection.html?lang=zh-Hant)資料集[!DNL Customer Journey Analytics]，在&#x200B;**[!UICONTROL 中建立連線]**。
