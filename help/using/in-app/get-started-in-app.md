...
>[!AVAILABILITY]
>
>目前，應用程式內頻道不適用於已購買Adobe Healthcare Shield附加產品的組織。
>
...
* 在開始之前，請確保您擁有 Journey Optimizer Campaign 的正確權限。[了解更多](../campaigns/get-started-with-campaigns.md#campaign-prerequisites)
