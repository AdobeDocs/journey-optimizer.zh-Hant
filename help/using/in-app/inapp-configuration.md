...
# 設定應用程式內通道 {#inapp-configuration}

傳送應用程式內訊息之前，您需先在 [!DNL Adobe Experience Platform Data Collection].

1. 從 [!DNL Adobe Experience Platform Data Collection] 帳戶，存取 **[!UICONTROL Datastream]** 按一下 **[!UICONTROL New datastream]**. 如需資料流建立的詳細資訊，請參閱 [本頁](https://aep-sdks.gitbook.io/docs/getting-started/configure-datastreams).
...
1. 接著，存取 **[!UICONTROL App surfaces]** ，然後按一下 **[!UICONTROL Create App surface]**.

   ![](assets/inapp_config_1.png)

1. 將名稱新增至 **[!UICONTROL App surface]**.
...
1. 按一下 **[!UICONTROL Save]** 完成 **[!UICONTROL App surface]**.

   ![](assets/inapp_config_3.png)

   您的 **[!UICONTROL App surface]** 現在當您使用應用程式內訊息建立新促銷活動時，即可使用。 [深入了解](create-in-app.md)
