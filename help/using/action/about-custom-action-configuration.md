...
1. 在&#x200B;**[!UICONTROL URL]**&#x200B;欄位中，指定外部服務的URL：
   ...
   * 如果URL包含動態路徑，請只輸入URL的靜態部分，也就是配置、主機、連線埠，以及（選擇性）路徑的靜態部分。
     ...
     將自訂動作新增至歷程時，您將指定URL的動態路徑。 [了解更多資訊](../building-journeys/using-custom-actions.md)。
...
1. 選取型別： **[!UICONTROL 常數]**&#x200B;或&#x200B;**[!UICONTROL 變數]**。 如果您已選取&#x200B;**[!UICONTROL 常數]**，請在&#x200B;**[!UICONTROL 值]**&#x200B;欄位中輸入常數值。 如果您已選取&#x200B;**[!UICONTROL 變數]**，則您將在新增自訂動作至歷程時指定此變數。 [了解更多資訊](../building-journeys/using-custom-actions.md)。
