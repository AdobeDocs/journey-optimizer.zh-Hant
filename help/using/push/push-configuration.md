...
>[!CAUTION]
>
>推送配置必須由專家用戶執行。 根據您的實施模式和參與此實施的人員，您可能需要將完整權限集分配給單個產品配置檔案，或在應用程式開發人員與 **Adobe Journey Optimizer** 管理員。 瞭解有關 **標籤** 權限 [本文檔](https://experienceleague.adobe.com/docs/experience-platform/tags/admin/user-permissions.html){target="_blank"}。
...
1. 從 **[!UICONTROL 產品]** 頁籤 **[!UICONTROL Adobe Experience Platform資料收集]** 卡。

   ![](assets/push_product_1.png)

1. 選擇現有 **[!UICONTROL 產品配置檔案]** 或用 **[!UICONTROL 新建配置檔案]** 按鈕 瞭解如何建立新 **[!UICONTROL 新建配置檔案]** 的 [管理控制台文檔](https://experienceleague.adobe.com/docs/experience-platform/access-control/ui/create-profile.html#ui){target="_blank"}。

1. 從 **[!UICONTROL 權限]** 頁籤 **[!UICONTROL 產權]**。

   ![](assets/push_product_2.png)

1. 按一下 **[!UICONTROL 全部添加]**。 這將在您的產品配置檔案中添加以下權限：
   * **[!UICONTROL 核准]**
   * **[!UICONTROL 開發]**
   * **[!UICONTROL 管理環境]**
   * **[!UICONTROL 管理擴展]**
...
1. 添加以下權限：
   ...
   * **[!UICONTROL 管理屬性]**
   ...
   這些權限是移動應用程式開發人員在中設定推送憑據所必需的 **Adobe Experience Platform資料收集** 並在中定義「推送通知」通道曲面（即消息預設） **Adobe Journey Optimizer**。

   ![](assets/push_product_5.png)

1. 按一下&#x200B;**[!UICONTROL 儲存]**。

分配此 **[!UICONTROL 產品配置檔案]** 對於用戶，請執行以下步驟：

1. 訪問 **[!DNL Admin Console]**。

1. 從 **[!UICONTROL 產品]** 頁籤 **[!UICONTROL Adobe Experience Platform資料收集]** 卡。

1. 選擇您以前配置的 **[!UICONTROL 產品配置檔案]**。

1. 從 **[!UICONTROL 用戶]** 按鈕 **[!UICONTROL 添加用戶]**。

   ![](assets/push_product_6.png)

1. 鍵入用戶名或電子郵件地址並選擇用戶。 然後，按一下 **[!UICONTROL 保存]**。
...
Adobe Experience Platform移動SDK通過Android和iOS相容的SDK為您的手機提供客戶端整合API。 關注 [Adobe Experience Platform移動SDK文檔](https://aep-sdks.gitbook.io/docs/getting-started/overview){target="_blank"} 在您的應用中使用Adobe Experience Platform移動軟體開發工具包進行設定。
...
1. 從 [!DNL Adobe Experience Platform Data Collection]，選擇 **[!UICONTROL 應用程式曲面]** 的下界。

1. 按一下 **[!UICONTROL 建立應用程式曲面]** 的子菜單。

   ![](assets/add-app-config.png)

1. 輸入 **[!UICONTROL 名稱]** 的子菜單。

1. 從 **[!UICONTROL 移動應用程式配置]**，選擇作業系統：

   * **為iOS**

      ![](assets/add-app-config-ios.png)

      1. 輸入移動應用 **捆綁包ID** 的 **[!UICONTROL 應用程式ID(iOS捆綁包ID)]** 的子菜單。 在 **常規** 中的 **XCode**。

      1. 開啟 **[!UICONTROL 推送憑據]** 按鈕來添加憑據。
   ...
   * **對於Android**
      ...
      1. 提供 **[!UICONTROL 應用ID（Android包名稱）]**:通常包名稱是您的應用程式ID `build.gradle` 的子菜單。
...
1. 輸入 **[!UICONTROL 顯示名稱]** 和 **[!UICONTROL 說明]**。 按一下 **[!UICONTROL 添加欄位組]** 完成。 有關如何建立欄位組的詳細資訊，請參閱 [XDM系統文檔](https://experienceleague.adobe.com/docs/experience-platform/xdm/tutorials/create-schema-ui.html?lang=zh-Hant){target="_blank"}。


   ![](assets/test_push_4.png)

1. 在左側，選擇架構。 在右窗格中，輸入方案名稱和說明。 為啟用此架構 **[!UICONTROL 配置檔案]**。

   ![](assets/test_push_4b.png)


1. 在左側，選擇欄位組，然後按一下+表徵圖以建立新欄位。 在 **[!UICONTROL 欄位組屬性]**，在右側鍵入 **[!UICONTROL 欄位名]**。 **[!UICONTROL 顯示名稱]** 選擇 **[!UICONTROL 字串]** 如 **[!UICONTROL 類型]**。

   ![](assets/test_push_5.png)

1. 檢查 **[!UICONTROL 必需]** 按一下 **[!UICONTROL 應用]**。

1. 按一下&#x200B;**[!UICONTROL 「儲存」]**。您的架構現在已建立，可用於事件。

然後你需要設定一個活動。

1. 從首頁的左菜單的「管理」下，選擇 **[!UICONTROL 配置]**。 按一下 **[!UICONTROL 管理]** 的 **[!UICONTROL 事件]** 的子菜單。

1. 按一下 **[!UICONTROL 建立事件]**，事件配置窗格將在螢幕右側開啟。
...
1. 按一下 **[!UICONTROL 編輯]** 的 **[!UICONTROL 事件ID條件]** 的子菜單。 拖放先前添加的欄位以定義系統將用於標識觸發行程的事件的條件。
...
1. 按一下 **[!UICONTROL 確定]** 然後 **[!UICONTROL 保存]**。

您的活動現在已建立，現在可以在旅途中使用。

1. 在左菜單中，按一下 **[!UICONTROL 旅程]**。

1. 按一下 **[!UICONTROL 建立行程]** 創造新的旅程。

1. 在右側顯示的設定窗格中，編輯歷程的屬性。瞭解更多資訊 [節](../building-journeys/journey-gs.md#change-properties)。

1. 從中拖放在前面步驟中建立的事件開始 **[!UICONTROL 事件]** 下拉。

   ![](assets/test_push_11.png)

1. 從 **[!UICONTROL 操作]** 拖放 **[!UICONTROL 推]** 你旅途的活動。

1. 配置推送通知。 有關如何建立推送通知的詳細資訊，請參閱此 [頁](create-push.md)。

1. 按一下 **[!UICONTROL Test]** 切換以開始測試推送通知，然後按一下 **[!UICONTROL 觸發事件]**。

   ![](assets/test_push_12.png)

1. 在 **[!UICONTROL 鍵]** 欄位，然後鍵入 **訂單確認** 的下界。
...
* 瞭解如何在中建立推送消息 [此頁](create-push.md)。
