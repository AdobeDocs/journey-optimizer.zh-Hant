...
* 新增章節，說明如何使用HTML元件，將RTF文字（例如分行符號、粗體、斜體等）新增及使用至可自訂的片段。 [閱讀全文](../content-management/customizable-fragments.md#rich-text)

* 決策部分已更新，其中包含專用於建立AI模型的特定區段。 [閱讀全文](../experience-decisioning/ranking/ai-models.md)
