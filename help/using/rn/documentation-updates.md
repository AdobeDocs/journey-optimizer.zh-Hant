...
* 「開始使用設定檔」和「護欄」頁面已新增附註，以指定在擷取資料時，電子郵件會區分大小寫，這表示在鎖定相對應的收件者時，可能會建立並使用重複的設定檔。 [閱讀全文](../audience/get-started-profiles.md)
...
* Experimentation Accelerator的檔案已重新放置到另一個集合。 [閱讀全文](https://experienceleague.adobe.com/en/docs/experimentation-accelerator/using/overview)
