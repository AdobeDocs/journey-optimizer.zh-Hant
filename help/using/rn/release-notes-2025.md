...
<p>如需詳細資訊，請參閱<a href="../landing-pages/lp-forms.md">詳細文件</a>以瞭解詳情。</p>
...
<p>如需詳細資訊，請參閱<a href="../campaigns/api-triggered-high-throughput.md">詳細說明文件</a>。</p>
<p>推出日期：2025 年 10 月 22 日</p>
</td>
</tr>
</tbody>
...
<tr>
<td>
<p>為了節省時間和精力，Journey Optimizer 現在可讓您從專用的 UI 選單建立可重複使用的規則，並在建立目標定位時運用這些規則，作為行銷活動或歷程中的內容最佳化的一部分，或是最佳化歷程活動。</p>
<p>目標定位規則目前處於「有限可用性」。 請聯絡您的 Adobe 代表以取得存取權。 請注意，此功能僅適用於已購買決策附加產品的組織。 此功能將逐步向所有客戶推出。</p>
<img src="assets/do-not-localize/targeting-rules.gif">
<p>如需詳細資訊，請參閱<a href="../experience-decisioning/rules.md">詳細說明文件</a>。</p>
<p>推出日期：2025 年 10 月 22 日</p>
</td>
</tr>
</tbody>
...
<p>如需詳細資訊，請參閱<a href="../personalization/functions/helpers.md#execution-metadata">詳細說明文件</a>。</p>
...
<thead>
<tr>
<th><strong>Experimentation Accelerator 與實驗代理</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>Journey Optimizer Experimentation Accelerator 現在包含實驗代理，這是 AI 支援的對話工具，可讓您與實驗、洞察和機會互動。 它增強了 Journey Optimizer Experimentation Accelerator 體驗，幫助您更高效地執行實驗、揭示有效之處，並探索下一步最佳化的目標。</p>
...
<p>如需詳細資訊，請參閱<a href="../email/pdf-attachments.md">詳細文件</a>以瞭解詳情。</p>
...
<p>如需詳細資訊，請參閱<a href="https://experienceleague.adobe.com/zh-hant/docs/experience-cloud-ai/experience-cloud-ai/agents/ajo-agent#journey-create-agent-skill-overview-and-user-guide" target="_blank">詳細文件</a></p>
...
* **簡訊管道的 mTLS 支援**
設定自訂簡訊提供者時，您現在可以選擇啟用雙向 TLS (mTLS) 驗證，這要求用戶端和伺服器在建立安全連線之前確認彼此的身分。 [閱讀全文](../mobile/mobile-configuration-custom.md) - 推出日期：2025 年 9 月 23 日
...
* **Webhook** - 此版本在設定自訂簡訊提供者時，為 Webhook 引進下列增強功能：
   ...
   * 您現在可以定義您的 Webhook 用途，可以是傳入或回饋，具體取決於您要擷取的資料類型。 [閱讀全文](../mobile/mobile-configuration-custom.md#webhook) - 推出日期：2025 年 9 月 23 日

   * 設定關鍵字的介面已經過改良，更易於設定。 [閱讀全文](../mobile/mobile-configuration-custom.md#webhook) - 推出日期：2025 年 9 月 23 日

* **簡訊**

   * 設定自訂簡訊提供者時，您現在可以定義當傳入的簡訊包含無法辨識的關鍵字時使用的&#x200B;**預設**&#x200B;關鍵字。 您也可以為特定動作建立&#x200B;**自訂**&#x200B;關鍵字。 [閱讀全文](../mobile/mobile-configuration-custom.md) - 推出日期：2025 年 9 月 23 日
...
<p>此外，您還可以將以輪廓屬性為基礎的退出條件 (之前稱為「全域篩選器」) 套用至已暫停歷程，即可根據屬性排除輪廓。</p>
...
<p>如需詳細資訊，請參閱<a href="../content-management/gs-message-optimization.md">詳細文件</a></p>
</td>
</tr>
</tbody>
</table>
...
* **管道 - 簡訊**
   ...
   * **模糊選擇退出** - 啟用時，**模糊選擇退出**&#x200B;選項會偵測與定義的選擇退出關鍵字 (例如「CANCIL」) 非常相似的傳入訊息，並自動傳送確認回覆以驗證使用者的取消訂閱意圖。 如果使用者透過定義的提示確認，則可以取消訂閱。 [閱讀全文](../mobile/mobile-configuration-sinch.md)

     >[!NOTE]
     >
     >**模糊選擇退出**&#x200B;僅適用於 Sinch 與 Infobip。

   * **驗證簡訊連線** - 您現在可以將範例訊息傳送至指定裝置，在 Adobe Journey Optimizer 中輕鬆測試和驗證簡訊 API 認證。 [閱讀全文](../mobile/mobile-configuration-sinch.md)
...
<p>如需詳細資訊，請參閱<a href="../content-management/brands.md">詳細說明文件</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<p>如需詳細資訊，請參閱<a href="../code-based/code-based-form-fields.md">詳細說明文件</a>。</p>
</td>
</tr>
</tbody>
</table>
...
<tr>
<td>
<p>在 Journey Optimizer 中，務必要管理行銷活動和歷程的流量和時間，才能避免過多的互動給客戶帶來負擔。 Journey Optimizer 目前有提供幾種可用於衝突管理和優先排序的工具，以前只適用於有限存取 (LA) 組織 - 現已普遍開放使用 (GA)。</p>
...
<p>如需詳細資訊，請參閱<a href="../conflict-prioritization/gs-conflict-prioritization.md">詳細說明文件</a>。</p>
...
<p>如需詳細資訊，請參閱<a href="../integrations/aem-fragments.md">詳細說明文件</a>。</p>
...
<p>此功能之前以「有限可用性」的名義發行，目前所有環境都適用 (一般可用性)。</p>
<p>如需詳細資訊，請參閱<a href="../integrations/aem-dynamic.md">詳細說明文件</a>。</p>
<p>推出日期：2025 年 5 月 23 日</p>
</td>
</tr>
</tbody>
...
<td>
<p>目前您可以使用輪廓 ID 和其他識別碼（例如訂購 ID、訂閱 ID 或處方 ID）來觸發歷程，即可允許同一設定檔同時出現在同一歷程中許多次。 這能啟用某些情境，同時管理許多訂單或訂閱，每個執行個體還會依循自己的歷程路徑操作。</p>
<p>如需詳細資訊，請參閱<a href="../building-journeys/supplemental-identifier.md">詳細說明文件</a>。</p>
...
<tr>
<td>
<p>完成批次分段後，就可以立即觸發日常歷程執行 目前所有客戶都可以在每日排程的歷程中，使用此選項。 此選項可讓您定義的時間視窗長達 6 小時之久，等待批次分段作業的客群資料，確保使用到最新資料，執行歷程。或者如果還未準備好，就可以直接跳過。</p>
<p>此功能之前以「有限可用性」的名義發行，目前所有環境都適用 (一般可用性)。</p>
...
<p>如需詳細資訊，請參閱<a href="../experience-decisioning/ranking/ranking-formulas.md">詳細說明文件</a>。</p>
<p>推出日期：2025 年 5 月 14 日</p>
</td>
</tr>
</tbody>
...
<p>如需詳細資訊，請參閱<a href="../building-journeys/success-metrics.md">詳細說明文件</a>。</p>
...
* **教戰手冊製作與分享 (Private beta)** - 您可以立即建立、管理並分享自己的使用案例教戰手冊。 此功能目前僅作為 Private Beta 使用，可提供給某些組織參考。 若想取得存取權，請聯絡 Adobe 代表。 [閱讀全文](../start/ai-features.md#playbooks)
...
<p>如需詳細資訊，請參閱<a href="../audience/creating-a-segment-definition.md#flexible">詳細文件</a>以瞭解詳情。</p>
</tr>
</tbody>
</table>
</table>
...
<p>如需詳細資訊，請參閱<a href="../content-management/generative-full-content.md">詳細說明文件</a>。</p>
</td>
</tr>
</tbody>
</table>
...
* **SMS 簡訊** — 您現在可以覆寫傳送、回饋、傳入和回撥 URL，以管理來自多區域端點的 SMS 簡訊傳送。 為了支援此功能，已在 API Credentials 設定中新增欄位覆寫 URL。 此變更僅適用於 Sinch 提供者。 [閱讀全文](../mobile/mobile-configuration-sinch.md)
...
* **決策** (推出日期：2025 年 1 月 28 日) — 決策現在在編輯專案目錄的結構描述時支援物件資料類型。 [閱讀更多](../experience-decisioning/catalogs.md)
