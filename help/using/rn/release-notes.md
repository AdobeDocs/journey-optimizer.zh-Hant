...
<thead>
<tr>
<th><strong>Customer Journey Analytics報表（一般可用性）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
...
**歷程** -  推出日期：2024 年 10 月 3 日

* **自訂動作中的參數** - 自訂動作目前支援 NULL 與可選參數。[了解更多](../action/about-custom-action-configuration.md#define-the-message-parameters)
