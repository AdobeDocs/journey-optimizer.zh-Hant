...
<tr>
<td>
<p>透過新的<strong>RCS Basic附加元件</strong>產品，您現在可以在Journey Optimizer中提供基本的Rich Communication Services (RCS)傳訊功能，以啟用下列增強型傳訊功能，但須受提供者與電信業者支援的約束：</p>
<ul>
...
<tr>
<td>
<p>透過Journey Optimizer，您現在可以透過登入頁面擷取<strong>個人資料屬性</strong>。 根據特定資料集建立、設計及管理根據您的需求量身打造的<strong>自訂表單</strong>。 然後，您可以在登陸頁面中善用自訂表單，將選擇的設定檔屬性新增至為每個表單定義的資料集。</p>
<p>此功能之前以「有限可用性」的名義發行，目前所有環境都適用 (一般可用性)。</p>
</td>
</tr>
</tbody>
