...
* **上下文資料** - 現在您可以在決策規則和排名公式中利用 Adobe Experience Platform 的內容資料。[閱讀全文](../experience-decisioning/context-data.md)
...
* **報告** - 現在您可以使用建立體驗決策活動的自訂報告儀表板[!DNL Customer Journey Analytics]。 [閱讀全文](../experience-decisioning/cja-reporting.md)
