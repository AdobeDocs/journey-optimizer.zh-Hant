...
<thead>
<tr>
<th><strong>CX Coworker中的訊息複製和電子郵件設計外掛程式</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>CX Coworker現在提供兩個新外掛程式，可簡化您從策略到部署的<strong>訊息和電子郵件工作流程</strong>：</p>
...
* **CX Coworker忠誠度建議技能** — 行銷人員現在可以在CX Coworker的對話介面中直接要求&#x200B;**挑戰機會**，根據真正的忠誠度計畫趨勢獲得紮實的挑戰想法，並在不離開聊天室的情況下將其轉換為即時挑戰。
...
<thead>
<tr>
<th><strong>CX Coworker中的歷程模擬（MCP和聊天）</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p>CX Coworker中的<strong>歷程模擬技能</strong>可自動進行端對端歷程驗證，並讓您輕鬆解讀結果。 請注意，此功能目前僅支援快速模擬流程，不會完全取代Journey Optimizer手動模擬體驗。</p>
</td>
</tr>
</tbody>
</table>
...
<thead>
<tr>
<th><strong>從CX Coworker邊欄建立歷程</strong><br/></th>
</tr>
</thead>
<tbody>
<tr>
<td>
<p><strong>現在可直接從CX Coworker右側邊欄使用AI建立歷程</strong>，將先前的AI Assistant體驗取代為品牌重塑的整合式進入點，以產生歷程。</p>
</td>
</tr>
</tbody>
</table>
...
* **衛生分析同事技能** - CX Coworker中的新「衛生分析」技能會掃描您的使用中歷程和草稿歷程，找出中斷的設定、無訊息失敗，以及過時或未使用的資產，例如過時的草稿歷程、孤立的資料來源和持續的自訂動作錯誤，並從聊天中直接顯示建議的修正。<!-- Documentation link: TBD -->

* **業務績效分析同事技能** - CX Coworker中的新&#x200B;**業務績效分析**&#x200B;技能可分析您的歷程執行情形、說明績效較低的領域，並建議具體的最佳化，例如重新參與等待、管道升級和傳送時間最佳化。 <!-- Documentation link: TBD -->
...
* **從CX Coworker產生決策規則** — 先前透過右側邊欄提供的&#x200B;**AI輔助決策規則產生**&#x200B;體驗現在可透過CX Coworker存取，其會取代右側邊欄，作為使用AI建立規則的方式。
