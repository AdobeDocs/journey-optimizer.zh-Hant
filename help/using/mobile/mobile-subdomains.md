...
**在此頁面上：**&#x200B;瞭解如何在Adobe Journey Optimizer中設定SMS子網域，以縮短訊息中的URL，方法是使用現有的委派子網域或設定具有DNS記錄的新子網域。
...
若要能夠縮短新增至SMS/RCS/MMS訊息的URL，您必須設定在[建立SMS設定](mobile-configuration.md#sms-prerequisites)時將選取的子網域。
...
使用子網域傳送SMS訊息之前，您必須先等到Adobe執行必要的檢查，這可能需要4小時。<!--Learn more in [this section](#subdomain-validation).--> 檢查成功後，子網域會取得&#x200B;**[!UICONTROL Success]**&#x200B;狀態。 它已準備好用來建立SMS通道設定。
