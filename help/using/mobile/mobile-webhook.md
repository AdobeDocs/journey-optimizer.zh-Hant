...
**在此頁面上：**&#x200B;瞭解如何在Adobe Journey Optimizer中建立傳入和回饋簡訊Webhook，以擷取Sinch、Infobip和自訂提供者的選擇加入和選擇退出同意回應以及傳遞事件。
...
1. 從&#x200B;**[!UICONTROL 傳入關鍵字類別]**&#x200B;下拉式清單中選取關鍵字類別，以設定：
   ...
   * 設定單一自訂關鍵字。 當使用者的訊息符合此關鍵字時，該關鍵字會寫入&#x200B;**[!UICONTROL AJO電子郵件追蹤]**&#x200B;資料集，以用於報告和建立受眾。
