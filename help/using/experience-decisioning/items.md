...
>abstract="透過將內容片段附加至此決策項目，您就能直接從 Adobe Experience Manager 中利用您的內容。"
...
1. 將片段新增至您的決定專案以豐富其內容。 支援兩種型別的片段：
   ...
   * **AEM內容片段** — 將Adobe Experience Manager內容片段直接對應至您的決定專案的屬性。 填寫&#x200B;**片段參考索引鍵**&#x200B;欄位，並在&#x200B;**值**&#x200B;欄位中選取片段。 對應後，即可在決策原則中選取內容片段欄位，而Journey Optimizer可最佳化要提供哪個片段給每個設定檔。 [了解作法](fragments-decision-policies.md#aem-fragments-decisioning)
