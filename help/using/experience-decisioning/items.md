...
>title="將Journey Optimizer內容片段對應至此決定專案"
>abstract="從您的Journey Optimizer片段資料庫附加內容片段。"

>[!CONTEXTUALHELP]
>id="ajo_exd_item_aem_fragment"
>title="將AEM內容片段對應至此決定專案"
>abstract="將內容片段附加至此決定專案，即可直接從Adobe Experience Manager運用您的內容。"
