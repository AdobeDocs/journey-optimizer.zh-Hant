...
* 建置[歷程路徑最佳化](../building-journeys/path-targeting.md)時。
...
1. 選取規則實體，以指定要為其建立規則的物件型別。
   ...
   * **[!UICONTROL 鎖定目標]** — 建置[鎖定目標](#targeting-rules)規則時，可使用此規則，做為行銷活動中[內容最佳化](../campaigns/campaigns-message-optimization.md#targeting)的一部分，或在[最佳化歷程活動](../building-journeys/path-targeting.md)中的歷程。
