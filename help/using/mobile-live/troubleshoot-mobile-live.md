...
在[Assurance檔案](https://experienceleague.adobe.com/en/docs/platform-learn/implement-mobile-sdk/app-implementation/assurance)中瞭解如何設定Adobe Experience Platform Assurance。

**注意**：針對iOS Live活動，請確認您的應用程式正在實體iOS裝置（iOS 16.1或更新版本）或Xcode模擬器（iOS 16.1或更新版本）上執行。
