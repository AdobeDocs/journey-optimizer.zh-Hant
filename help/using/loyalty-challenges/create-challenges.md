...
在「結構」索引標籤中，定義挑戰的組織方式：其屬性、排程、要完成的工作和要給予的獎勵。
...
1. 從下拉式清單中選取您的&#x200B;**[!UICONTROL 獎勵提供者]**。 這是管理客戶點數和獎勵的忠誠度解決方案。

1. 根據您選取的傳送方式設定獎勵金額：

   +++完成挑戰時提供獎勵

   在挑戰完成&#x200B;**欄位的[數目]忠誠度點數**&#x200B;中，指定當客戶完成整個挑戰時要給予的總獎勵金額。
...
>[!NOTE]
>
>「忠誠度挑戰」不包含追蹤獎勵餘額的內建分類帳系統。 確保您選取的獎勵提供者處理點數追蹤和贖回。
...
1. 導覽至&#x200B;**[!UICONTROL 內容]**&#x200B;標籤。

1. 輸入內容卡的&#x200B;**[!UICONTROL 名稱]**。

1. 選取&#x200B;**[!UICONTROL 通道設定]**。 頻道設定包含所有用於傳送訊息的技術引數，例如標頭引數、子網域、行動應用程式等。 [進一步瞭解通道設定](../configuration/channel-surfaces.md)。

1. 選取&#x200B;**[!UICONTROL 編輯內容]**&#x200B;以設計您的內容卡。

   ![](assets/challenge-create-content.png)

[瞭解如何設計和個人化內容卡](../content-card/design-content-card.md)。
...
1. 選取![](assets/do-not-localize/Smock_More_18_N.svg)圖示並選擇&#x200B;**[!UICONTROL 編輯]**&#x200B;來設計您的訊息內容。
   ...
   * [瞭解如何建立應用程式內訊息](../in-app/get-started-in-app.md)
   * [瞭解如何建立電子郵件訊息](../email/get-started-email.md)
   * [瞭解如何建立推播通知](../push/get-started-push.md)
...
1. 導覽至「**[!UICONTROL 對象]**」標籤，然後選取「**[!UICONTROL 選取對象]**」。

   ![](assets/challenge-create-audience.png)

1. 從可用的Adobe Experience Platform對象清單中選取您的目標對象。
...
* [管理挑戰](manage-challenges.md) — 編輯、監控並最佳化您的挑戰
