...
1. 使用 **[!UICONTROL 資格]** 欄位以限制此位置的優惠方案選擇。
   ...
   此限制可使用套用 **決定規則**，或一或數個 **Adobe Experience Platform對象**. 兩者皆詳見 [本節](../offer-library/add-constraints.md#segments-vs-decision-rules).

   * 若要將優惠方案的選擇限制在Experience Platform對象的成員，請選取 **[!UICONTROL 受眾]**，然後按一下 **[!UICONTROL 新增對象]**.

     ![](../assets/activity_constraint_segment.png)

     從左窗格新增一或多個對象，並使用 **[!UICONTROL 和]** / **[!UICONTROL 或]** 邏輯運運算元。
