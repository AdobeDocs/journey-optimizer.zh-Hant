...
如果客戶不符合其他優惠的資格，則會傳送後援優惠給他們。 建立備援選件的步驟包括建立一或多個表示法，例如建立選件時。

您可以對[!DNL Offer Library] API執行單一GET請求，以檢視容器中所有備援選件的清單。
...
| `limit` | 限制傳回的備援選件數。 | `limit=5` |

**回應**

成功的回應會傳回您有權存取的容器內所顯示之備援選件清單。
