...
使用個人化編輯器，使用聯合結構描述擷取儲存在Adobe Experience Platform中的設定檔屬性。 [深入瞭解](https://experienceleague.adobe.com/docs/experience-platform/profile/union-schemas/union-schemas-overview.html){target="_blank"}有關決定管理中支援的函式，請參閱運算式編輯器中的[支援的函式](../personalization-editor-supported-functions.md)。
