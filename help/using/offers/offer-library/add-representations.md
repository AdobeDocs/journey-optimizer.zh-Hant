...
如果選取的位置為HTML型別，您也可以新增來自[Adobe Experience Cloud資產庫](https://experienceleague.adobe.com/docs/experience-manager-assets-essentials/help/introduction.html){target="_blank"}的HTML或JSON內容。
