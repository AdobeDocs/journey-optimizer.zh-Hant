...
>additional-url="https://experienceleague.adobe.com/en/docs/zh-hant/journey-optimizer/using/offer-decisioning/rankings/ai-models/create-ranking-strategies#create-ranking-strategy" text="建立 AI 模型"
