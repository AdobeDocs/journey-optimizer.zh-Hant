...
>[!TIP]
>
>[!DNL Adobe Journey Optimizer] 的新決策功能「決策」現在可透過程式碼型體驗和電子郵件管道使用！ [進一步了解決策](../../experience-decisioning/gs-experience-decisioning.md)
...
![個人化最佳化模型動畫](../../rn/assets/do-not-localize/ai-ranking.gif)
